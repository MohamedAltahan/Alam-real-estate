                    ...
                    <div>
                        ...
                        <div class="flex gap-2" dir="ltr">
                            <div class="relative w-[48%] shrink-0">
                                ...
                                <svg class="absolute end-3 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="m6 9 6 6 6-6"/></svg>
                            </div>
                            <input name="phone" type="tel" inputmode="tel" autocomplete="tel-national" value="{{ old('phone') }}" dir="ltr" placeholder="" class="{{ $field }} min-w-0 text-start">
                        </div>
