...
@php
    ...
    $nav = collect([
        ...
        ['label' => 'المهام',         'route' => 'dashboard.tasks.index', 'active' => 'dashboard.tasks.*', 'icon' => 'kanban', 'permission' => 'tasks.view'],
        ...
        ['label' => 'ميداني',         'route' => 'dashboard.field-owners.index', 'active' => 'dashboard.field-owners.*', 'icon' => 'compass', 'permission' => 'field_owners.view'],
        ...
        ['label' => 'سجل النشاط',     'route' => 'dashboard.activity.index', 'active' => 'dashboard.activity.*', 'icon' => 'activity', 'permission' => 'activity.view'],
