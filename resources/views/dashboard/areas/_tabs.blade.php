{{-- تبويبات المناطق / المدن (صفحتان تتشاركان صلاحيات المناطق) --}}
...
<div class="inline-flex items-center gap-1 rounded-full bg-gray-100/70 border border-gray-100 p-1 mb-5">
    @foreach (['areas' => ['المناطق', route('dashboard.areas.index')], 'cities' => ['المدن', route('dashboard.cities.index')]] as $key => [$label, $url])
