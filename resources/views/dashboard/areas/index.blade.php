...
<div x-data="areaCrud()">
    ...
    <form method="GET" id="areas-filters" data-live-filters class="mb-4">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        @forelse ($areas as $area)
                            @php
                                ...
                                $isUsed = $area->properties_count + $area->clients_count + $area->owners_count > 0 || $onHomepage;
                                $editData = [
                                    'id' => $area->id,
                                    'name_ar' => $nameAr,
                                    'name_en' => $nameEn,
                            ...
                            <tr class="hover:bg-gray-50/50">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex flex-wrap gap-1.5">
                                        ...
                                        @endif
                                        @if ($area->clients_count)
                                            <span class="rounded-full bg-info-soft text-info px-2.5 py-1 text-xs">{{ $area->clients_count }} عميل</span>
                                        @endif
                        ...
                        @empty
                            <tr><td colspan="6" class="px-4 py-16 text-center text-gray-400">لا توجد مناطق مطابقة.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
