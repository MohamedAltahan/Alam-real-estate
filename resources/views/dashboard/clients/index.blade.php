...
@php
    ...
    $filterInput =
        'w-full rounded-field bg-white border border-gray-200 px-3.5 h-10 text-sm text-end focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/15';
