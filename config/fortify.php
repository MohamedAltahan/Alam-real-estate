...
return [
    ...
    */
    ...
    'features' => [
        // لا يوجد تسجيل عام — الموظفون يُنشأون من الداشبورد
        Features::resetPasswords(),
        // Features::emailVerification(),
        Features::updateProfileInformation(),  // تبويب "الملف" في إعدادات الحساب
        Features::updatePasswords(),           // تبويب "الأمان" — تغيير كلمة المرور
    ],
